...
describe QueueItemsController do
	...
	describe "POST create" do
		...
		it "puts the video as the last one in the queue" do
			...
			south_park_queue_item = QueueItem.where(video_id: south_park.id, user_id: alic.id).first
	...
	describe "POST update_queue" do
		...
		context "with invalid inputs" do
			...
			it "redirect_to the my queue page" do
		...
		context "with unauthenticated users" do
			it "redirects to sign path" do
				post :update_queue, queue_items: [{id: 5, position: 3}, {id: 2, position: 1}]
				expect(response).to redirect_to sign_in_path
			end
		end
