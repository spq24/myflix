...
feature 'User registers', {js: true, vcr: true} do
	...
	scenario "with invalid user info and valid card" do
		...
		fill_in_valid_card
		click_button "Sign Up"
		expect(page).to have_content("Oops something went wrong. Please check the information you entered")
	end
	...
	def fill_in_valid_card
		...
		fill_in "7 - July", from: "date_month"
		fill_in "2015", from: "date_year"
	end

	def fill_in_invalid_card
		fill_in "Credit Card Number", with: "13241"
		fill_in "Security Code", with: "123"
		fill_in "7 - July", from: "date_month"
		fill_in "2015", from: "date_year"
	end
